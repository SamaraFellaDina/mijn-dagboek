...
git push --force
```
* robin liet mij vandaag een website zien genaamd [anime.js](https://animejs.com/documentation/timer/timer-callbacks). Ik wil hier meer ontwikkelingen. mee documenteren en gaan kijken of ik dit kan implenmenteren op m’n portfolio 
* https://www.dora.run/
